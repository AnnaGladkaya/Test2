let question_arr = ["Яке місто є столицею Польщі?","Яка тварина є символом Польщі?","В якому місті Польщі є метрополітен?","У Варшаві є вулиця названа на честь..?","Який відомий композитор був поляком?"]
let a1_arr = ["Лодзь","Лелека","Краків","Кота Леопольда","Іоганн Себастьян Бах"]
let a2_arr = ["Гданськ","Заєць","Варшава","Карлсона","Фридерик Фопен"]
let a3_arr = ["Варшава","Кінь","Вроцлав","Чебурашки","Людвіг ван Бетховен"]
let a4_arr = ["Познань","Бобер","Бидгощ","Вінні Пуха","Вольфганг Амадей Моцарт"]
let answer_arr = ["Варшава","Лелека","Варшава","Вінні Пуха","Фридерик Фопен"]
let n_right_answer_arr = [3,1,2,4,2]
